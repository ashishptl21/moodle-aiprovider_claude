...
/**
 * Privacy provider implementation for provider
 *
...
class provider implements
    ...
    public static function get_metadata(collection $collection): collection {
        $collection->add_external_location_link('aiprovider_claude', [
            ...
            'numberimages' => 'privacy:metadata:aiprovider_claude:numberimages',
            'responseformat' => 'privacy:metadata:aiprovider_claude:responseformat',
